...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={"verbose_name": "学习日志", "verbose_name_plural": "学习日志",},
        ),
        migrations.CreateModel(
            name="LearningPlan",
            fields=[
                ...
                (
                    "description",
                    models.TextField(blank=True, null=True, verbose_name="学习计划描述"),
                ),
                (
                    "thumbnail",
                    models.ImageField(
                        blank=True, null=True, upload_to="", verbose_name="封面图片"
                    ),
                ),
                ("is_public", models.BooleanField(default=False, verbose_name="公开")),
            ],
            options={"verbose_name": "学习计划", "verbose_name_plural": "学习计划",},
        ),
        migrations.CreateModel(
            name="Profile",
            fields=[
