    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_additional', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='video_additional')),
                ('thumbnail', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='thumbnail')),
                ('is_free', models.BooleanField(default=False, verbose_name='免费试看')),
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='courses.course', verbose_name='所属课程')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_image', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='question_image')),
                ('answer_image', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='answer_image')),
